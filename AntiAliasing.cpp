...
void AntiAliasing::setupMSAA(int WINDOW_WIDTH, int WINDOW_HEIGHT)
{
...
void AntiAliasing::applyNone()
{
}

void AntiAliasing::applyMSAA()
{
}

void AntiAliasing::applyFXAA()
{
}

void AntiAliasing::applySMAA()
{
}
